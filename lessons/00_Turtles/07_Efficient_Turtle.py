...
tina.goto(x=100,y=100)                                      # Move tina to another spot on the screen
...
tina.goto(x=50,y=100)                                      # Move tina to another spot on the screen
...
tina.goto(x=-50,y=-100)           # Draw a hexagon
